    ...
    <div className="top-0 z-50 w-full shadow-sm bg-base-100">
      <div className="navbar max-w-7xl mx-auto">
        ...
        <div className="navbar-start">
          ...
          <Link to="/" className="btn btn-ghost text-xl font-bold">ForumHub</Link>
        </div>
        ...
        <div className="navbar-end gap-4 items-center">
          {/* Notification Icon */}
          <div className="relative tooltip tooltip-bottom mr-2" data-tip="Notifications">
            <button className="btn btn-ghost btn-circle">
              <span className="material-icons">notifications</span>
              <div className="badge badge-sm badge-error absolute -top-1 -right-1">2</div>
            </button>
          </div>
          ...
          {user ? (
            <div className="dropdown dropdown-end ml-2">
              ...
              >
                <li>
                  <span className="px-4 py-2 text-sm text-gray-600 font-medium">{user.displayName}</span>
                </li>
                <li>
